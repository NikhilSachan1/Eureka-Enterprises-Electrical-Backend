...
export enum CommunicationCategory {
  ...
  ATTENDANCE_SUBMISSION = 'ATTENDANCE_SUBMISSION',
  ...
  FUEL_EXPENSE_SUBMISSION = 'FUEL_EXPENSE_SUBMISSION',
  FUEL_EXPENSE_REIMBURSEMENT = 'FUEL_EXPENSE_REIMBURSEMENT',
  LEAVE_APPROVAL = 'LEAVE_APPROVAL',
  LEAVE_SUBMISSION = 'LEAVE_SUBMISSION',
