...
export const CRON_NAMES = {
  ...
  MARK_APPROVAL_PENDING: 'MarkApprovalPending',
...
export const CRON_GROUPS = {
  ...
  // Then mark previous day's pending attendance, then create today's attendance
  DAILY_MIDNIGHT: [
...
export const SYSTEM_NOTES = {
  ...
  MARKED_APPROVAL_PENDING: 'Marked approval pending by system - day ended',
