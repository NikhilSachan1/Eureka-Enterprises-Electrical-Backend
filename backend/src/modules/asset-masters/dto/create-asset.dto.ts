...
export class CreateAssetDto {
  @ApiProperty({ description: 'Asset ID (unique identifier)', example: 'AST-TL-201' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(50)
  assetId: string;
  ...
  // ==================== Master Info ====================
  @ApiProperty({ description: 'Asset name', example: 'Combination Plyer' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(255)
  name: string;
  ...
  @ApiProperty({ description: 'Asset category (from config)', example: 'Hand Tool' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(100)
  category: string;
  ...
  @ValidateIf((o) => o.assetType === AssetType.CALIBRATED)
  @IsOptional()
  @IsDateString()
